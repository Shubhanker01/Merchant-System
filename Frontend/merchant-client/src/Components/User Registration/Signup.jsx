    ...
    return (
        <>
            ...
            <div className='bg-[#282A36] h-screen'>
                <div>
                    <h1 className='text-center sm:text-4xl font-bold text-2xl pt-[20px] text-[#F8F8F2]'>Signup page</h1>
                </div>
                <h1 className='text-center sm:text-2xl text-md pt-[30px] mb-[15px] text-[#F8F8F2]'>This is Step 1 of 3. Enter your email and verify your account to register</h1>
